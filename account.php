...
<title>Dinesh prakash||mocktest </title>
...
<a href="https://github.com/Maahi10001" target="_blank">About us</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/GG.jpg" width=100 height=100 alt="DP" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Dinesh prakash</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 6969696969</h4>
		<h4 style="font-family:'typo' ">dinesh prakash@gmail.com</h4>
		<h4 style="font-family:'typo' ">SNIST</h4></div></div>
		</p>
      </div>
